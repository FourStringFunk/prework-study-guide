...
DU Bootcamp prework project

## Description

I built a basic study guide capturing my learnings from the Prework Modules associated with the DU Coding Bootcamp. The modules focused on learning Git, HTML, CSS, and Javascript. 
